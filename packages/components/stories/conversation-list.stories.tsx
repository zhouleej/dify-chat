...
export const Primary: Story = {
  ...
  render: function Render() {
    ...
    return <div className='w-full'>
      <ConversationList items={items} deleteConversationPromise={(conversationId: string) => {
      setItems(conversationItems.slice(conversationItems.findIndex(item => item.key === conversationId), 1))
