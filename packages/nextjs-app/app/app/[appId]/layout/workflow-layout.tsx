...
export default function WorkflowLayout({ appMode }: { appMode: AppModeEnums }) {
	...
	return (
		<div className="block md:!flex md:items-stretch w-full h-full overflow-y-auto md:overflow-y-hidden bg-(--theme-bg-color)">
			{/* 参数填写区域 */}
			...
			{appMode === AppModeEnums.WORKFLOW && (
				<div className="md:flex-1 px-4 pt-6 overflow-x-hidden overflow-y-auto bg-(--theme-bg-color)">
