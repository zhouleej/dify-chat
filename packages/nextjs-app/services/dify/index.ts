...
export class DifyApi {
	...
	renameConversation = (params: {
		...
		return this.baseRequest.put(`/${this.options.appId}/conversation/${conversation_id}/name`, {
			...restParams,
		})
	}
	...
	deleteConversation = (conversation_id: string) => {
		return this.baseRequest.delete(`/${this.options.appId}/conversation/${conversation_id}`)
	}
	...
	getConversationHistory = (conversation_id: string) => {
		return this.baseRequest
			.get(`/${this.options.appId}/conversation/${conversation_id}/messages`, {})
	...
	sendMessage = (params: {
		...
		return this.baseRequest.baseRequest(`/${this.options.appId}/chat-messages`, {
			method: 'POST',
	...
	stopTask = async (taskId: string) => {
		return this.baseRequest.post(`/${this.options.appId}/chat-messages/${taskId}/stop`)
	}
	...
	runWorkflow = async (params: { inputs: Record<string, IFile[] | unknown> }) => {
		return this.baseRequest.baseRequest(`/${this.options.appId}/workflows/run`, {
			method: 'POST',
			body: JSON.stringify({
				...params,
				response_mode: 'streaming',
	...
	completion = async (params: { inputs: Record<string, IFile[] | unknown> }) => {
		return this.baseRequest.baseRequest(`/${this.options.appId}/completion-messages`, {
			method: 'POST',
			body: JSON.stringify({
				...params,
				response_mode: 'streaming',
